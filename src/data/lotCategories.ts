...
export const lotCategories = [
  ...
  },
  {
    ...
    image: import.meta.env.BASE_URL + "lovable-uploads/56a22ae8-3d6d-4ba7-8201-dffcf2eb9132.png",
    price: "$140,000",
    pricePerSqFt: "$70/sf",
    recommended: true
  },
  {
    ...
    image: import.meta.env.BASE_URL + "lovable-uploads/46049fac-37d0-4492-b0c8-8141c080f816.png",
    price: "$55,000",
